...
class UserPostDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            ...
            $actionedit="<a href='".route('user.post.edit',$query->id)."' class='btn btn-primary'>
            <i class='far fa-edit'></i></a>";
            $actiondelete="<a href='".route('user.post.destroy',$query->id)."' class='btn btn-danger ml-2 delete-item'>
